...
def run_scheduler():
    from requests_management.schedule import create_schedule, schedule_agv, start_position_update_thread
    try:
        ...
        # Start background thread for position updates without rescheduling
        start_position_update_thread(update_interval=10)  # Update every 10 seconds
        logger.info("Position update thread started successfully")
